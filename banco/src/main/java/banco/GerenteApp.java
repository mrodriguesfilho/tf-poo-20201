...
public class GerenteApp implements Banco{
	...
	public boolean login(Gerente dadosGerente) throws Exception {
	...
	public int FinalizarConta(Conta conta) {
		try {
	...
	public ArrayList<String> listarClientes() {
		try {
            ...
            while(rs.next()){
                clientes.add("CONTA: " + rs.getInt("numeroagencia") + "/" + rs.getInt("numeroconta") + "\n" +
